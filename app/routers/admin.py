...
def admin_page(request:Request, db:SessionDep, user:AdminDep, page: int = Query(default=1, ge=1), limit: int = Query(default=10, le=100), q: str = Query(default=''), done:str =  Query(default="any")):
    offset = (page - 1) * limit
